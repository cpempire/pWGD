...
# pSVGD_post['label'] = 'pSVGD-post d={}'.format(d)
...
# pWGF_post['label'] = 'pWGF-post d={}'.format(d)
...
algorithms = [SVGD, pSVGD, WGF, pWGF]
# algorithms = [SVGD]
